...
const SelectScreen = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        return () => {
            ...
            return (
                <div
                    class={['d-select-screen', dropBoxStatus && 'd-select-screen-none']}
                    onClick={(e) => {
                        e.stopPropagation();
                        openDropBox();
                    }}
                ...
                >
                    ...
                    >
                        <i
                            class={[
                                'd-select-screen-svg',
                                icon === 'triangle' && !dropBoxStatus && 'd-select-triangle-open',
                                activeSvg.value && 'd-select-screen-svg-active'
                            ]}
                            ref={refTrigger}
                        >
