        ...
        return () => {
            ...
            return (
                <div
                    class={[
                        'd-sidebar-custom',
                        pointX && 'd-sidebar-custom-col-resize',
                        windowWidth >= 1920 ? 'd-sidebar-custom-large' : 'd-sidebar-custom-normal'
                    ]}
                ...
                >
                    ...
                    <>
                        {width && (
                            <div
                                class={{
                                    'd-sidebar-custom-bar': true,
                                    'd-sidebar-custom-bar-change-size': changeSize && leftWidth
                                }}
                    ...
                    <>
                        {openClose && (
                            <div
                                class={[
                                    'd-sidebar-custom-btn',
                                    leftWidth
                                        ? 'd-sidebar-custom-btn-normal'
                                        : 'd-sidebar-custom-btn-rotate'
                                ]}
                                style={{
                    ...
                    <div
                        v-show={leftShow}
                        class="d-sidebar-left"
                        style={{ width: `${leftWidth}px` }}
                    >
                        {slots.left()}
                    </div>
                    <div class="d-sidebar-right" style={{ width: `calc(100% - ${leftWidth}px)` }}>
                        {slots.right()}
                    </div>
                </div>
            );
