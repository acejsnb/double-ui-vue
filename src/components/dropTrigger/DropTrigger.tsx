	...
	setup(props, { emit }) {
		...
		watch(
			...
			(n, o) => {
				...
				setTimeout(() => {
					state.inputShow = n;
					if (n) {
						if (!props.multiple || !popoverTip) return;
						// 关闭popoverTip
		...
		return () => {
			...
			return (
				...
				>
					<div
						class={['p-drop-trigger-main', `p-drop-trigger-main-${type}`]}
						onClick={() => {
							dropOpenClick();
						}}
					>
										...
										{hasSelected.value ? (
											...
											>
												{multiple ? (
													...
													>
														<span
															class="p-drop-trigger-selected-m"
															ref={tag}
														>
															已选择
															<span
																class="p-drop-trigger-selected-m-c"
																ref={countTag}
															>
													...
													<span
														class="p-drop-trigger-selected-s"
											...
											<span class="p-drop-trigger-placeholder p-drop-trigger-text-overflow">
												{placeholder}
											</span>
										)}
									</>
									...
									>
										<section class="p-drop-trigger-tag-list">
											{(selectedData as Item[]).map((sd: Item) => (
												<article
													class="p-drop-trigger-tag-list-item"
													key={sd.id}
												>
													<span
														class="p-drop-trigger-tag-list-text p-drop-trigger-text-overflow"
														style={{
					...
					>
						...
						<i
							class="p-drop-trigger-svg p-drop-trigger-del"
